...
<!--we have the vision, mission, and values here-->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <h5 class="fs-2 text-body-emphasis"><u>Vision</u><img src="/visionicon.png" height="30"></h5>
        <br>
      ...
      <div class="col-md-4">
        <h2><u>Values</u> <img src="/valuesicon.png" height="40"></h2>
        <br>
        <br>
