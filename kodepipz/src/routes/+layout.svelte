<nav class="navbar navbar-expand-lg bg-body-tertiary container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="https://classroom.jhenbert.com/?redirect=0">Coding for Kids</a></li>
  ...
  <footer class="py-3 my-4" style="background-color: whitesmoke;">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      ...
      <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Tutor now</a></li>
      <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Terms of Service</a></li>
      <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Vision & Mission</a></li>
      <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Social</a></li>
    </ul>
